...
const (
	...
	DUOBB_CREATE_PLAN_OVER_LIMIT_ERROR
	
	DUOBB_QG_INVITE_MEMBER_ERROR = 100
	DUOBB_QG_MEMBER_EXIT_ERROR
	DUOBB_QG_SCORE_SETTING_ERROR
	DUOBB_QG_SIGN_ERROR
	DUOBB_QG_COMMIT_ORDER_ERROR
	DUOBB_QG_CONFORM_ORDER_ERROR
	DUOBB_QG_ADD_BLACK_ERROR
	DUOBB_QG_ADD_WHITE_ERROR
	DUOBB_QG_DEL_BLACK_ERROR
	DUOBB_QG_DEL_WHITE_ERROR
	DUOBB_QG_GET_BLACK_ERROR
	DUOBB_QG_GET_WHITE_ERROR
)
